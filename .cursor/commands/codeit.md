...
1. **Run local code review** by following the `@.cursor/skills/review-code/SKILL.md` skill:
   - Pass "current branch" as the target
   - The skill will run all applicable review subagents and generate a findings report
