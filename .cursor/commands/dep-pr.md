...
2. **Read `~/.cursor/commands/pr-create.md` now** (use the Read tool — do NOT skip this). Then follow its steps 2-8 (assess state, branch setup, implement, push, verify, PR, link, report).
